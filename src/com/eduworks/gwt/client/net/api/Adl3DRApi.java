...
public class Adl3DRApi {
	...
	public static void searchADL3DR(String queryString, Adl3DRCallback<Adl3DRPacket> callback) {
		if (ADL3DR_OPTION_MODE.equals(ADL3DR_ENABLED)) {			
			CommunicationHub.sendHTTP(CommunicationHub.POST,
									  AlfrescoURL.getAlfresco3drDispatchSearchURL(queryString), 
									  null,
									  false, 
									  callback);
		}
	...
	public static void getADL3DRobject(String id, Adl3DRCallback<Adl3DRPacket> callback) {
		if (ADL3DR_OPTION_MODE.equals(ADL3DR_ENABLED)) {			
			CommunicationHub.sendHTTP(CommunicationHub.POST,
									  AlfrescoURL.getAlfresco3drDispatchIdURL("metadata",id), 
									  null,
									  false, 
									  callback);
		}
	...
	public static void getADL3DRobjectReview(String id, Adl3DRCallback<Adl3DRPacket> callback) {
		if (ADL3DR_OPTION_MODE.equals(ADL3DR_ENABLED)) {			
			CommunicationHub.sendHTTP(CommunicationHub.POST,
									  AlfrescoURL.getAlfresco3drDispatchIdURL("reviews",id), 
									  null,
									  false, 
									  callback);
		}
	...
	public static void putADL3DRactivity(String id, String activityString, Adl3DRCallback<Adl3DRPacket> callback) {
		if (ADL3DR_OPTION_MODE.equals(ADL3DR_ENABLED)) {			
			CommunicationHub.sendHTTP(CommunicationHub.POST,
									  AlfrescoURL.getAlfresco3drDispatchReviewURL(id), 
									  activityString,
									  false, 
									  callback);
		}
